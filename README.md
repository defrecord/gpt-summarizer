...
1. Clone the repository:
   ```bash
   git clone https://github.com/defrecord/gpt-summarizer.git
   cd gpt-summarizer
   ```
...
## Community
- [GitHub Discussions](https://github.com/defrecord/gpt-summarizer/discussions)
- [Issue Tracker](https://github.com/defrecord/gpt-summarizer/issues)
